const CACHE='farol-cache-v7';
const ASSETS=['./','./index.html','./style.css','./app.js?v=7','./manifest.webmanifest',
'./assets/icon-192.png','./assets/icon-512.png','./assets/icon-1024.png','./assets/favicon-32.png','./assets/favicon-16.png','./favicon.ico'];
